...
const FieldItem = ({ field, onUpdateField, onDeleteField, onAddField }) => {
  return (
    <Card 
      size="small" 
      className="mb-4 shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100"
      bodyStyle={{ 
        padding: '16px',
        borderRadius: '6px'
      }}
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-3 mb-3 flex-wrap">
          <Input
            ...
            className="flex-1 min-w-[180px] h-9 px-3 rounded-md border border-gray-300 hover:border-blue-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-200 transition-colors"
            size="small"
          />
          ...
          <Select
            ...
            className="w-[180px] h-9 [&>.ant-select-selector]:h-9 [&>.ant-select-selector]:rounded-md [&>.ant-select-selector]:border-gray-300 [&>.ant-select-selector]:hover:border-blue-400"
            size="medium"
          >
        ...
        {field.type === 'nested' && (
          <div className="ml-8 pl-4 border-l-2 border-gray-200 mt-3">
            <FieldList
